...
const CustomPerpdexGuide = ({ airdrop, onBack }) => (
  <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 max-w-4xl mx-auto pb-24 md:pb-12">
    <button onClick={onBack} className="text-gray-400 hover:text-white mb-6 flex items-center gap-2 transition-colors outline-none focus:outline-none focus:ring-0">
      ← Voltar para o Hub
    </button>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-4">
          ...
          <div className="flex items-center flex-wrap gap-2 text-xs font-medium w-full md:w-auto">
            ...
            <button
              ...
              className={`flex-1 sm:flex-none flex items-center justify-center gap-1.5 transition-colors px-3 py-2 rounded-lg border outline-none select-none focus:outline-none focus:ring-0 ${
                savedInternal
            ...
            <button
              ...
              className="flex-1 sm:flex-none flex items-center justify-center gap-1.5 transition-colors bg-gray-900/50 hover:bg-gray-800 px-3 py-2 rounded-lg border border-gray-800 text-gray-400 hover:text-white outline-none select-none focus:outline-none focus:ring-0"
            >
          ...
          return (
            <div key={phase.id} className="bg-[#111] border border-gray-800 rounded-xl overflow-hidden transition-all duration-200">
              <button
                ...
                className="w-full px-5 py-4 flex items-center justify-between bg-[#151515] hover:bg-[#1a1a1a] transition-colors text-left outline-none select-none focus:outline-none focus:ring-0"
              >
                <div className="flex items-center gap-4">
                  <div
                          ...
                          <div className="flex flex-col sm:flex-row gap-5 justify-between items-start sm:items-center">
                                ...
                                <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2">
                                  {task.subLinks.map((sub, idx) => (
                                    <a
                                      ...
                                      className="text-xs flex items-center justify-between px-3 py-2 bg-[#0A0A0A] hover:bg-gray-900 border border-gray-800 rounded-lg text-gray-400 hover:text-white transition-colors group outline-none focus:outline-none focus:ring-0"
                                    >
                            ...
                            <div className="flex flex-row sm:flex-col items-center sm:items-stretch gap-3 w-full sm:w-auto mt-4 sm:mt-0">
                              ...
                              <button
                                ...
                                className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-xs font-semibold transition-colors border outline-none select-none focus:outline-none focus:ring-0 ${
                                  isTaskDone
