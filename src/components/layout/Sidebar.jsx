            ...
            {category.items ? (
              <>
                <button 
                  ...
                  className="w-full flex items-center justify-between px-3 py-2 text-gray-400 hover:text-white transition-colors outline-none select-none focus:outline-none focus:ring-0"
                >
                    ...
                    {category.items.map(item => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full flex items-center justify-between gap-3 px-4 py-2.5 rounded-r-lg transition-all font-medium text-sm outline-none select-none focus:outline-none focus:ring-0 ${
              ...
              <button
                ...
                className={`w-full flex items-center justify-between px-3 py-2.5 rounded-lg transition-all font-bold text-xs uppercase tracking-wider outline-none select-none focus:outline-none focus:ring-0 ${
      ...
      {userTier === 'admin' && (
        <div className="mt-6 pt-6 border-t border-gray-800 px-2">
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all font-bold text-sm outline-none select-none focus:outline-none focus:ring-0 ${
              currentRoute === 'admin' 
